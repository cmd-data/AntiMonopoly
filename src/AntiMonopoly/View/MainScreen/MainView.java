...
public class MainView extends GridPane {
    ...
    private void initialiseNodes() {
        ...
        this.nk13 = new ImageView("/images/neemKaart.png");
        //#2
        this.nk21 = new Label("Kaart");
        this.nk22 = new Label("Trek een kaart");
        this.nk23 = new ImageView("/images/neemKaart.png");
        //#3
        this.nk31 = new Label("Kaart");
        this.nk32 = new Label("Trek een kaart");
        this.nk33 = new ImageView("/images/neemKaart.png");
        //#4
        this.nk41 = new Label("Kaart");
        this.nk42 = new Label("Trek een kaart");
        this.nk43 = new ImageView("/images/neemKaart.png");
        //#5
        this.nk51 = new Label("Kaart");
        this.nk52 = new Label("Trek een kaart");
        this.nk53 = new ImageView("/images/neemKaart.png");
        //#6
        this.nk61 = new Label("Kaart");
        this.nk62 = new Label("Trek een kaart");
        this.nk63 = new ImageView("/images/neemKaart.png");

        //Belastingen
        //Eigendomsbelasting
        this.eb1 = new Label("Eigendomsbelasting");
        this.eb2 = new Label("€75");
        this.eb3 = new ImageView("/images/eigendomsbelasting.png");

        //Inkomstenbelasting
        this.ib1 = new Label("Inkomstenbelasting");
        this.ib2 = new Label("€200*");
        this.ib3 = new ImageView("/images/inkomstenbelasting.png");

        //Enegiebedrijven
        //elektriciteitsmaatschappij
        this.em1 = new Label("Elektriciteitsmaatschappij");
        this.em2 = new Label("Dobbel voor rekening");
        this.em3 = new ImageView("/images/elektriciteit.jpg");


        //Gasmaatschappij
        this.gas1 = new Label("gasmaatschappij");
        this.gas2 = new Label("Dobbel voor rekening");
        this.gas3 = new ImageView("/images/gas.png");


        //Hoektegels
        //Ga naar de gevangenis
        this.gng1 = new Label("Ga naar de gevangenis");
        this.gng2 = new ImageView("/images/gaNaarDeGevangenis.jpg");

        //Start
        this.start1 = new Label("Start");
        this.start2 = new Label("Ontvang €200");
        this.start3 = new ImageView("/images/start.jpg");

        //Gevangenis
        this.gev1 = new Label("Gevangenis");
        this.gev2 = new ImageView("/images/gevangenis.jpg");

        //Antimonopolystichting
        this.ams1 = new Label("Anti-monopoly stichting");
        this.ams2 = new Label("Dobbel voor ontvangst");
        this.ams3 = new ImageView("/images/stichting.png");
